...
const resources = {
    en: {
        translation: {
            ...
            'label.pmValue': "Project manager",
            'label.devValue': "Developer",
            'label.testerValue': "Tester",
            'label.designerValue': "Designer",
            'label.male': "Male",
            'label.female': "Female",
            'label.other': "Other",
    ...
    ua: {
        translation: {
            ...
            'label.pmValue': "Керівник проекту",
            'label.devValue': "Розробник",
            'label.testerValue': "Тестувальник",
            'label.designerValue': "Дизайнер",
            'label.male': "Чоловік",
            'label.female': "Жінка",
            'label.other': "Інше",
